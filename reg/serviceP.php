<?php
include('PhpDatabaseInsertSER.php');
?>
<html lang="en">
<head>
		...
		<div class="wrap-contact100" style="background-color: rgba(255, 145, 76, 0.8)">
			<form class="contact100-form validate-form" method="POST">
				...
				<div class="wrap-input100 input100-select">
					<span class="label-input100">Service Provided</span>
					<div>
						<select class="selection-2" name="stype" required>
				...
				<button class="button button--light" name="submit" type="submit">
								Login
							</button>
				</div>
			</form>
