		...
		<div class="wrap-contact100" style="background-color: rgba(255, 145, 76, 0.8)">
			<form class="contact100-form validate-form" method="POST">
				...
				<div class="wrap-input100 validate-input" data-validate="Name is required">
					...
					<input class="input100" type="text" name="vname" placeholder="Enter your Company's Name" required>
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 input100-select">
					...
					<div>
						<select class="selection-2" name="vtype" required>
				...
				<div class="wrap-input100 input100-select">
					<span class="label-input100">Venue's Capacity</span>
					<div>
						<select class="selection-2" name="vsize" required>
						<option value="Choose">Choose</option>
					<option value="Male">Big</option>
					<option value="Female">Medium</option>
					<option value="Both">Small</option>
						</select>
					</div>
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 validate-input" data-validate = "Message is required">
					<span class="label-input100">Briefly Describe Your Venue</span>
					<textarea class="input100" name="bio" placeholder="Your description here..." required></textarea>
					<span class="focus-input100"></span>
				</div>
